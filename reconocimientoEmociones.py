...
def emotionImage(emotion):
    ...
    # Emojis
    if emotion == 'Felicidad': image = cv2.imread('D:/UP/Python/OmesTutorials2020-master/RECONOCIMIENTOEMOCIONES/Emojis/felicidad.jpeg')
    elif emotion == 'Enojo': image = cv2.imread('D:/UP/Python/OmesTutorials2020-master/RECONOCIMIENTOEMOCIONES/Emojis/enojo.jpeg')
    elif emotion == 'Dormitar': image = cv2.imread('D:/UP/Python/OmesTutorials2020-master/RECONOCIMIENTOEMOCIONES/Emojis/sorpresa.jpg')
    elif emotion == 'Tristeza': image = cv2.imread('D:/UP/Python/OmesTutorials2020-master/RECONOCIMIENTOEMOCIONES/Emojis/tristeza.jpeg')
